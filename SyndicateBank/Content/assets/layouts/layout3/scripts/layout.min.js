...
$('.cus-drop-down>a').click(function(){
	$(this).next('ul.first').slideToggle(300);
});

$('.cus-drop-down2').click(function(){
...
$('.pwd').hide(0);
$('.e-pwd').hide(0);
	$('.checkbox-list button').hide(0);
});

$('#e-pwd').change(function()
{
	if($('#e-pwd option:selected').val()=='Password')
	{
		$('.e-pwd').show(500);
	}
	else {
...
$('#signed').click(function()
{
	if($(this).prop('checked'))
	{
		$('.checkbox-list button').show(500);
	}
	else {
		$('.checkbox-list button').hide(500);
	}
});

$('.checkbox-list button').click(function(){
